                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu multi-level">
                                    <li class="dropdown-submenu">
                                       <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-building" aria-hidden="true"></i>  Company  </a>
                                        <ul class="dropdown-menu">
                                             <li><a href="{{route('addCompany')}}">Add Company</a></li>
                                             <li role="separator" class="divider"></li>
                                            <li><a href="{{route('viewAllCompany')}}">View All Companies</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-plane" aria-hidden="true"></i> Trip </a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ticket" aria-hidden="true"></i> Ticket </a>
                                        <ul class="dropdown-menu">
                                            <!-- <li><a href="">Print Ticket</a></li> -->
                                            <li role="separator" class="divider"></li>
                                            <li><a href="{{route('viewTicketTrip')}}">View Trip Description</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>   
