                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('add_ferry_post') }}" enctype="multipart/form-data">
                        ...
                        @if (Auth::user()->role == RoleType::$ADMIN)
                            <div  class="form-group{{ $errors->has('company_id') ? ' has-error' : '' }}">
                                  <label class="col-md-4 control-label" for="company_id">Company Name</label>
                                  <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('captain_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="captain_name" type="text" class="form-control" name="captain_name" value="{{ old('captain_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('number_of_seat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="number_of_seat" type="number" class="form-control" name="number_of_seat" value="{{ old('number_of_seat') }}">
                        ...
                        <div class="form-group{{ $errors->has('number_of_crew') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="number_of_crew" type="number" class="form-control" name="number_of_crew" value="{{ old('number_of_crew') }}">
