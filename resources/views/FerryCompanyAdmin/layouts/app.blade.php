                    ...
                    @if(!Auth::guest())
                        ...
                        @if(Auth::user()->role == RoleType::$CUSTOMER)
                             <ul class="nav navbar-nav" style="padding-top: 10px">
                                <li><a href="{{route('viewCompanyAllUser')}}">View All Trips</a></li>
                            </ul>  
                        @else
                          <ul class="nav navbar-nav" style="padding-top: 10px">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu multi-level">
                                    <li class="dropdown-submenu">
                                       <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-building" aria-hidden="true"></i>  Company  </a>
                                        <ul class="dropdown-menu">
                                            <li><a href="{{ route('editUserCompany')}}">View Edit Company</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route('addAdminForm')}}">Add Admin</a></li>
                                            <li role="separator" class="divider"></li>
                                            <li><a href="{{route('viewCompanyAllUser')}}">View All User</a></li>
                                            <!--<li class="dropdown-submenu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                             <li><a href="{{route('addCompanyFerry')}}">Add Ferry</a></li>
                                             <li role="separator" class="divider"></li>
                                             <li><a href="{{route('viewAllCompanyFerry')}}">View All Ferry</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route('addCompanyTrip')}}">Add Trip</a>
                                            </li>
                                            <li role="separator" class="divider"></li>
                                            <li><a href="{{route('viewAllCompanyTrip')}}">View All Trips</a></li>
                                        </ul>
                                    </li>
